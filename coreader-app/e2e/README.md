...
2. **Database seeding**:
   ...
   node infra/db/scripts/seed.js
   ```

3. **Environment variables** (.env file):
   ```
   MONGODB_URI=mongodb://localhost:27017
   MONGODB_DB_NAME=coreader-test
   ```
...
Tests use seed data from `/infra/db/seeds/20250201000000-sample-data.js` which includes:
...
- Verify seed data is loaded: `node infra/db/scripts/seed.js`
